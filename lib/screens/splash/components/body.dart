...
class _BodyState extends State<Body> {
  ...
  List<Map<String, String>> splashData = [
    {
      "text": "Shop the Best in Home Decor at Our Online Marketplace",
      "image": "assets/images/splash_11.png"
    },
    {
      "text":
          "Find everything you need to decorate and style your home, all in one place.",
      "image": "assets/images/splash_21.png"
    },
    {
      "text":
